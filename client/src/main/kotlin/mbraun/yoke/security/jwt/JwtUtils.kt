...
@Component
class JwtUtils(@Autowired jwtConfig: JwtConfig, private val secretKey: SecretKey) {
    private val jwtSecret: String = jwtConfig.secretKey

    private val jwtExpirationDays = jwtConfig.tokenExpirationAfterDays
